...
void ConfigureGame(GLFWwindow* window){
...
void ZombieShooter(GLFWwindow* window){
    ...
    Engine::Editor().SetEnemies({0.16f, 0.3f}, 0.2f, 20);
    ...
    Engine::Editor().SetEnemiesConf(0.3f, 100.f, 15.f, 33.f);
    Engine::Editor().SetPlayerConf(100.f, 0.3f, 30, 0.8f);
